        ...
        try:
            while True:
                ...
                if len(nnData) > 0:
                    ...
                    print("label : {}".format(nnData[0].label))
                    print("confidence : {}".format(nnData[0].confidence))
                    print("xmax : {}".format(nnData[0].xmax))
                    print("xmin : {}".format(nnData[0].xmin))
                    print("ymax : {}".format(nnData[0].ymax))
                    print("ymin : {}".format(nnData[0].ymin))
                    print("spCor.x : {}".format(nnData[0].spatialCoordinates.x))
                    print("spCor.y : {}".format(nnData[0].spatialCoordinates.y))
                    print("spCor.z : {}".format(nnData[0].spatialCoordinates.z))
